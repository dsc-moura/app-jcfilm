...
<div class="modal fade" id="pesquisa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pesquisa Cliente</h5>
                ...
                <form>
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button type="button" onclick="Pesquisando('tabela-lista-clientes');" class="btn btn-primary"><i class="fas fa-search"></i></button>
                        </div>
                    </div>
                </form>
	...
	<script type="text/javascript">
     ...
     function Inicializar() {
        $("#salvar-cad-cliente").on("click", () => $("#FormCadCliente").submit()); 
     ...
     function HabilitarDesabilitarBotoes(view){
    	LiberaBloqueiaCamposFormulario(true);
 		$('#Update-cliente').prop("disabled",view);
		$('#salvar-cad-cliente').prop("disabled",view);
 		$('#Excluir-cliente').prop("disabled",view);
 		$('#Cancelar-cliente').prop("disabled",view);
     }
